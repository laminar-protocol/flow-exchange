...
describe('precision', () => {
  it('fromPrecision', () => {
    ...
    expect(fromPrecision(new BN('1011132131200'), 4, { pad: true, commify: true })).toEqual('101,113,213.1200');
    ...
    expect(() => fromPrecision('3786123861283612368,136812638172638126381263812638', 100)).toThrowError();
  });
  it('toPrecision', () => {
