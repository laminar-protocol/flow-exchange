...
export const toWei = (amount: BN | string) => ethereum.ethProvider.utils.toWei((amount || '0'), 'ether');
export const toBN = (amount: BN | string) => ethereum.ethProvider.utils.toBN((amount || '0'));
